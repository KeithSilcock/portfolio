...
! function($) {
        ...
        $(window).on('scroll',function() {
            ...
            if (a == 0 && $(window).scrollTop() > oTop) {
                $('.lan_fun_value').each(function() {
                    var $this = $(this),
                        countTo = $this.attr('listData-count');
                    $({
                        countNum: $this.text()
                    }).animate({
                            countNum: countTo
    ...
    ElvishApp.prototype.initPortfolioFilter = function() {
        $(window).on('load', function () {
            ...
            $filter.find('a').on("click",function() {
                var selector = $(this).attr('listData-filter');
    ...
    ElvishApp.prototype.initTypedText = function() {
        $(".element").each(function() {
            var $this = $(this);
            $this.typed({
                strings: $this.attr('listData-elements').split(','),
                typeSpeed: 100,
                backDelay: 3000
            });
        });
    ...
    //Text Rotate
    ElvishApp.prototype.initTextRotate = function() {
    ...
    //Youtube Background
    ElvishApp.prototype.initYoutubeBG = function() {

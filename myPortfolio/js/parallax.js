...
(function (window) {
    ...
    var Jarallax = (function () {
        ...
        function Jarallax_inner (item, userOptions) {
            ...
            dataOptions      = JSON.parse(_this.$item.getAttribute('listData-jarallax') || '{}');
    ...
    Jarallax.prototype.init = function () {
        ...
        _this.$item.setAttribute('listData-jarallax-original-styles', _this.$item.getAttribute('style'));
    ...
    Jarallax.prototype.destroy = function () {
        ...
        var originalStylesTag = _this.$item.getAttribute('listData-jarallax-original-styles');
        _this.$item.removeAttribute('listData-jarallax-original-styles');
    ...
    // listData-jarallax initialization
    addEventListener(window, 'DOMContentLoaded', function () {
        plugin(document.querySelectorAll('[listData-jarallax], [listData-jarallax-video]'));
    });
}(window));
